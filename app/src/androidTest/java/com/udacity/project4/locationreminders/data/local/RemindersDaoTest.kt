...
class RemindersDaoTest {
    ...
    fun saveReminder_GetById() = runBlockingTest {
        val reminder = ReminderDTO("My Shop", "Get to the Shop", "NsrCity", 3.599542, 4.62548123)
    ...
    fun getAllRemindersFromDb() = runBlockingTest {
        val reminder = ReminderDTO("My Shop", "Get to the Shop", "NsrCity", 3.599542, 4.62548123)
        val reminder2 = ReminderDTO("My Work place", "Get to the office", "SudiArabia", 6.57545, 7.53845)
